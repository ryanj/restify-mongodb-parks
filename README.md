...
To deploy a clone of this application using the [`rhc` command line tool](http://rubygems.org/gems/rhc), type:
    ...
    rhc app create locations nodejs-0.10 mongodb-2.4 --from-code=https://github.com/ryanj/restify-mongodb-parks.git
    rhc app configure locations --deployment-branch=target
    
Or, [link to a web-based **clone+deploy**](https://openshift.redhat.com/app/console/application_type/custom?name=locations&cartridges%5B%5D=nodejs-0.10&cartridges%5B%5D=mongodb-2&initial_git_url=https%3A%2F%2Fgithub.com%2Fryanj%2Frestify-mongodb-parks.git&initial_git_branch=target) on [OpenShift Online](http://OpenShift.com) or [your own open cloud](http://openshift.github.io): 

    https://openshift.redhat.com/app/console/application_type/custom?name=locations&cartridges%5B%5D=nodejs-0.10&cartridges%5B%5D=mongodb-2&initial_git_url=https%3A%2F%2Fgithub.com%2Fryanj%2Frestify-mongodb-parks.git&initial_git_branch=target
